...
const Roast = () => {
  ...
  return (
    <WavyBackground className="min-h-screen bg-background py-8">
      {/* Floating emojis */}
      <FloatingEmoji emoji="💀" className="top-[5%] right-[10%]" delay={0} size="lg" />
      <FloatingEmoji emoji="🔥" className="top-[20%] left-[5%]" delay={300} size="md" />
      <FloatingEmoji emoji="😭" className="bottom-[30%] right-[5%]" delay={600} size="lg" />
          ...
          <Card variant="default" className="animate-fade-in-up delay-300">
            <CardContent className="p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button variant="neon" onClick={handleShare} className="col-span-2">
