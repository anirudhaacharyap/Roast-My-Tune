...
<div className="text-center max-w-4xl mx-auto mb-12">
  <h1 className="font-script text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-tight mb-6">
    <StaggeredText text="Let AI " className="mr-2" />
    <span className="relative inline-block">
      {/* Special custom animation for the gradient text to match stagger timing */}
      <StaggeredText text="roast" className="relative z-10 text-gradient-neon pr-2" initialDelay={0.4} />
      <span className="absolute -bottom-2 left-0 w-full h-4 bg-primary/30 -rotate-1 animate-scale-in delay-700" />
    </span>
    <br />
    <StaggeredText text="your music taste." initialDelay={0.8} />
  </h1>
